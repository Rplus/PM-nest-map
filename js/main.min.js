...
function postData(_dialog) {
  ...
  return new Promise(function (resolve, reject) {
    ...
    xhr.addEventListener('loadstart', function () {
      ...
      _dialog.postTimer = setTimeout(function () {
        if (xhr.status === 200) {
          return;
        }
...
function submitFn(e) {
  ...
  postData(_dialog).then(function (d) {
    ...
    _dialog.postCB(); // alert('請確認「寶可夢編號」為數字！');
...
function createNamesOption(names) {
  _dialog.elm.pmList.innerHTML = names.map(function (name, idx) {
    return name[1] ? returnOption(idx + 1, name[0]) : null;
  }).join('') + returnOption(0.5, '？', 1);
}

var twoWeekinMs = 86400000 * 14;

var checkOutdated = function checkOutdated(data) {
  return new Date() - new Date(data.timestamp) > twoWeekinMs;
};

var checkLatLng = function checkLatLng(data) {
...
function getData() {
  ...
  Promise.all([fetchJSON(urls.GAS), fetchJSON("".concat(urls.GAS, "&method=get_pm_name"))]).then(function (d) {
    var data = d[0].data.filter(function (data) {
      return checkLatLng(data);
    });
    var pmNames = d[1];
...
var twBounds = L.latLngBounds(L.latLng(21.92, 118), L.latLng(26, 122.5)); // layers source: https://leaflet-extras.github.io/leaflet-providers/preview/

var layers = {
  'Google': Leaflet.tileLayer('https://{s}.google.com/vt/lyrs=m&x={x}&y={y}&z={z}', {
    bounds: twBounds,
    maxZoom: 20,
    subdomains: ['mt0', 'mt1', 'mt2', 'mt3'],
    attribution: '&copy; Google Map'
  }),
  'Wikimedia': Leaflet.tileLayer('https://maps.wikimedia.org/osm-intl/{z}/{x}/{y}{r}.png', {
    minZoom: 1,
    maxZoom: 19,
    attribution: '<a href="https://wikimediafoundation.org/wiki/Maps_Terms_of_Use">Wikimedia</a>'
  }),
  'Esri.WorldStreetMap': Leaflet.tileLayer('https://server.arcgisonline.com/ArcGIS/rest/services/World_Street_Map/MapServer/tile/{z}/{y}/{x}', {
  ...
  //     ext: 'png'
  //   }),
  'Stamen.TonerLite': Leaflet.tileLayer('https://stamen-tiles-{s}.a.ssl.fastly.net/toner-lite/{z}/{x}/{y}{r}.{ext}', {
    attribution: 'Map tiles by <a href="http://stamen.com">Stamen Design</a>, <a href="http://creativecommons.org/licenses/by/3.0">CC BY 3.0</a> &mdash; Map data &copy; <a href="https://www.openstreetmap.org/copyright">OpenStreetMap</a> contributors',
    subdomains: 'abcd',
    minZoom: 0,
    maxZoom: 20,
  ...
  'Hydda.Full': Leaflet.tileLayer('https://{s}.tile.openstreetmap.se/hydda/full/{z}/{x}/{y}.png', {
    maxZoom: 18,
    attribution: 'Tiles courtesy of <a href="http://openstreetmap.se/" target="_blank">OpenStreetMap Sweden</a> &mdash; Map data &copy; <a href="https://www.openstreetmap.org/copyright">OpenStreetMap</a> contributors'
  }),
  'Hydda.Base': Leaflet.tileLayer('https://{s}.tile.openstreetmap.se/hydda/base/{z}/{x}/{y}.png', {
    maxZoom: 18,
    attribution: 'Tiles courtesy of <a href="http://openstreetmap.se/" target="_blank">OpenStreetMap Sweden</a> &mdash; Map data &copy; <a href="https://www.openstreetmap.org/copyright">OpenStreetMap</a> contributors'
  }),
  'CartoDB.Positron': Leaflet.tileLayer('https://{s}.basemaps.cartocdn.com/light_all/{z}/{x}/{y}{r}.png', {
    attribution: '&copy; <a href="https://www.openstreetmap.org/copyright">OpenStreetMap</a> contributors &copy; <a href="https://carto.com/attributions">CARTO</a>',
    subdomains: 'abcd',
    maxZoom: 19
  }),
  'CartoDB.PositronNoLabels': Leaflet.tileLayer('https://{s}.basemaps.cartocdn.com/light_nolabels/{z}/{x}/{y}{r}.png', {
    attribution: '&copy; <a href="https://www.openstreetmap.org/copyright">OpenStreetMap</a> contributors &copy; <a href="https://carto.com/attributions">CARTO</a>',
    subdomains: 'abcd',
    maxZoom: 19
  }),
  'CartoDB.Voyager': Leaflet.tileLayer('https://{s}.basemaps.cartocdn.com/rastertiles/voyager/{z}/{x}/{y}{r}.png', {
    attribution: '&copy; <a href="https://www.openstreetmap.org/copyright">OpenStreetMap</a> contributors &copy; <a href="https://carto.com/attributions">CARTO</a>',
    subdomains: 'abcd',
    maxZoom: 19
  }),
  'CartoDB.VoyagerNoLabels': Leaflet.tileLayer('https://{s}.basemaps.cartocdn.com/rastertiles/voyager_nolabels/{z}/{x}/{y}{r}.png', {
    attribution: '&copy; <a href="https://www.openstreetmap.org/copyright">OpenStreetMap</a> contributors &copy; <a href="https://carto.com/attributions">CARTO</a>',
    subdomains: 'abcd',
    maxZoom: 19
  }),
  'Stamen.Watercolor': Leaflet.tileLayer('https://stamen-tiles-{s}.a.ssl.fastly.net/watercolor/{z}/{x}/{y}.{ext}', {
    attribution: 'Map tiles by <a href="http://stamen.com">Stamen Design</a>, <a href="http://creativecommons.org/licenses/by/3.0">CC BY 3.0</a> &mdash; Map data &copy; <a href="https://www.openstreetmap.org/copyright">OpenStreetMap</a> contributors',
    subdomains: 'abcd',
    minZoom: 1,
    maxZoom: 16,
  ...
  'Stamen.Terrain': Leaflet.tileLayer('https://stamen-tiles-{s}.a.ssl.fastly.net/terrain/{z}/{x}/{y}{r}.{ext}', {
    attribution: 'Map tiles by <a href="http://stamen.com">Stamen Design</a>, <a href="http://creativecommons.org/licenses/by/3.0">CC BY 3.0</a> &mdash; Map data &copy; <a href="https://www.openstreetmap.org/copyright">OpenStreetMap</a> contributors',
    subdomains: 'abcd',
    minZoom: 0,
    maxZoom: 18,
...
var labels = {
  'Stamen.TonerLabels': Leaflet.tileLayer('https://stamen-tiles-{s}.a.ssl.fastly.net/toner-labels/{z}/{x}/{y}{r}.{ext}', {
    attribution: 'Map tiles by <a href="http://stamen.com">Stamen Design</a>, <a href="http://creativecommons.org/licenses/by/3.0">CC BY 3.0</a> &mdash; Map data &copy; <a href="https://www.openstreetmap.org/copyright">OpenStreetMap</a> contributors',
    subdomains: 'abcd',
    ext: 'png'
  })
...
/* global L */
window.Leaflet = window.L;
var layerName = localStorage.getItem('custom-layer');
...
map.on('moveend', setPosition).on('moveend', renderMarkersInView).on('load', onLoad).on('locationfound', onLocationFound).on('locationerror', onLocationError).on('baselayerchange', saveLayerName).setView(position.latLng, position.zoom);
...
var lightenMap = aside.querySelector('#lighten-map');
lightenMap.checked = localStorage.getItem('lighten-map') === 'true'; // init

var checkToLightenMap = function checkToLightenMap() {
  document.body.classList.toggle('lighten-map', lightenMap.checked);
};

lightenMap.addEventListener('change', function () {
